...
# Link Hosting Kalian
scriptakmvpn="raw.githubusercontent.com/racunzx/akm/main/websocket"

# Getting Proxy Template
wget -q -O /usr/local/bin/ws-nontls https://${scriptakmvpn}/websocket.py
chmod +x /usr/local/bin/ws-nontls

# Installing Service
cat > /etc/systemd/system/ws-nontls.service << END
[Unit]
Description=Python Proxy Mod By scriptakm ZX
...
# Getting Proxy Template
wget -q -O /usr/local/bin/ws-ovpn https://${scriptakmvpn}/ws-ovpn.py
...
# Getting Proxy Template
wget -q -O /usr/local/bin/ws-tls https://${scriptakmvpn}/ws-tls

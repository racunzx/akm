...
# ==================================================
# Link Hosting Kalian
scriptakmvpn="raw.githubusercontent.com/racunzx/akm/main/ipsec"
...
wget -O /usr/bin/addl2tp https://${scriptakmvpn}/addl2tp.sh && chmod +x /usr/bin/addl2tp
wget -O /usr/bin/dell2tp https://${scriptakmvpn}/dell2tp.sh && chmod +x /usr/bin/dell2tp
wget -O /usr/bin/addpptp https://${scriptakmvpn}/addpptp.sh && chmod +x /usr/bin/addpptp
wget -O /usr/bin/delpptp https://${scriptakmvpn}/delpptp.sh && chmod +x /usr/bin/delpptp
wget -O /usr/bin/renewpptp https://${scriptakmvpn}/renewpptp.sh && chmod +x /usr/bin/renewpptp
wget -O /usr/bin/renewl2tp https://${scriptakmvpn}/renewl2tp.sh && chmod +x /usr/bin/renewl2tp
touch /var/lib/scriptakmstorevpn/data-user-l2tp
touch /var/lib/scriptakmstorevpn/data-user-pptp
rm -f /root/ipsec.sh

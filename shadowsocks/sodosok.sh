#!/bin/bash
#shadowsocks-libev obfs install by scriptakm ZX
...
# Link Hosting Kalian
scriptakmvpn="raw.githubusercontent.com/racunzx/akm/main/shadowsocks"
...
cd /usr/bin
wget -O addss "https://${scriptakmvpn}/addss.sh"
wget -O delss "https://${scriptakmvpn}/delss.sh"
wget -O cekss "https://${scriptakmvpn}/cekss.sh"
wget -O renewss "https://${scriptakmvpn}/renewss.sh"
chmod +x addss
chmod +x delss
chmod +x cekss
chmod +x renewss

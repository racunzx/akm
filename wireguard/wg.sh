...
# ==================================================
# Link Hosting Kalian
scriptakmvpn="raw.githubusercontent.com/racunzx/akm/main/wireguard"
...
echo -e "${Info} Wireguard Script By scriptakm ZX"
...
# Tambahan
cd /usr/bin
wget -O addwg "https://${scriptakmvpn}/addwg.sh"
wget -O delwg "https://${scriptakmvpn}/delwg.sh"
wget -O renewwg "https://${scriptakmvpn}/renewwg.sh"
chmod +x addwg
chmod +x delwg
chmod +x renewwg
cd

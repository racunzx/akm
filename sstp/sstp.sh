...
# Link Hosting Kalian
scriptakmvpn="raw.githubusercontent.com/racunzx/akm/main/sstp"
...
touch /var/lib/scriptakmstorevpn/data-user-sstp
...
wget -O /etc/accel-ppp.conf "https://${scriptakmvpn}/accel.conf"
...
#input perintah sstp
wget -O /usr/bin/addsstp https://${scriptakmvpn}/addsstp.sh && chmod +x /usr/bin/addsstp
wget -O /usr/bin/delsstp https://${scriptakmvpn}/delsstp.sh && chmod +x /usr/bin/delsstp
wget -O /usr/bin/ceksstp https://${scriptakmvpn}/ceksstp.sh && chmod +x /usr/bin/ceksstp
wget -O /usr/bin/renewsstp https://${scriptakmvpn}/renewsstp.sh && chmod +x /usr/bin/renewsstp
rm -f /root/sstp.sh
